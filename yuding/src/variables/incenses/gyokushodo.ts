...
const daily: Incense[] = [
	{
		...
		ingredients: [Ingredients.japaneseBayTreeBark, Ingredients.aloeswoodVietnamese, Ingredients.sandalwoodIndian, Ingredients.florals, Ingredients.spices],
		...
		price: 0,
		pricePerStick: 26,
		quantity: stock.gyokushodo?.['jinko-hoen'] || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		manufacturer: manufacturers.gyokushodo,
		series: manufacturers.gyokushodo.series?.daily,
		ingredients: [Ingredients.japaneseBayTreeBark, Ingredients.aloeswood, Ingredients.sandalwoodIndian, Ingredients.clove, Ingredients.benzoin, Ingredients.borneol],
		features: [Features.daily, Features.natural],
		burnTime: 30,
		lenght: 14,
		origin: origin.japan,
		price: 0,
		pricePerStick: 38,
		quantity: stock.gyokushodo?.['jinko-yomei'] || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		price: 0,
		pricePerStick: 22,
		quantity: stock.gyokushodo?.['jinko-kojurin'] || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		manufacturer: manufacturers.gyokushodo,
		series: manufacturers.gyokushodo.series?.daily,
		ingredients: [Ingredients.japaneseBayTreeBark, Ingredients.aloeswood, Ingredients.sandalwoodIndian, Ingredients.cinnamon, Ingredients.clove, Ingredients.borneol],
		features: [Features.daily, Features.natural],
		burnTime: 30,
		lenght: 14,
		origin: origin.japan,
		price: 0,
		pricePerStick: 18,
		quantity: stock.gyokushodo?.kojurin || 0,
		isActive: true,
		inStock: true,
	},
];
...
const lowSmoke: Incense[] = [
	{
		...
		ingredients: [Ingredients.japaneseBayTreeBark, Ingredients.benzoin, Ingredients.clove, Ingredients.sandalwoodIndonezian, Ingredients.cinnamon, Ingredients.nard, Ingredients.kaikou, Ingredients.borneol],
		...
		price: 0,
		pricePerStick: 14,
		quantity: stock.gyokushodo?.omiya || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		manufacturer: manufacturers.gyokushodo,
		series: manufacturers.gyokushodo.series?.lowSmoke,
		ingredients: [Ingredients.japaneseBayTreeBark, Ingredients.charcoal, Ingredients.clove],
		features: [Features.daily, Features.lowSmoke],
		burnTime: 30,
		lenght: 14,
		origin: origin.japan,
		price: 0,
		pricePerStick: 16,
		quantity: stock.gyokushodo?.sofu || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		manufacturer: manufacturers.gyokushodo,
		series: manufacturers.gyokushodo.series?.lowSmoke,
		ingredients: [Ingredients.japaneseBayTreeBark, Ingredients.charcoal, Ingredients.sandalwoodIndian, Ingredients.sandalwoodOil, Ingredients.borneol],
		features: [Features.daily, Features.lowSmoke],
		burnTime: 30,
		lenght: 14,
		origin: origin.japan,
		price: 0,
		pricePerStick: 22,
		quantity: stock.gyokushodo?.['seikyo-kojurin'] || 0,
		isActive: true,
		inStock: true,
	},
];
