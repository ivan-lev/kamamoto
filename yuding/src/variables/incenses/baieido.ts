...
const kobunboku: Incense[] = [
	{
		...
		price: 0,
		pricePerStick: 28,
		quantity: stock.baieido?.kobunboku || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		price: 0,
		pricePerStick: 28,
		quantity: stock.baieido?.['kaden-kobunboku'] || 0,
		isActive: true,
		inStock: true,
	},

	{
		...
		price: 0,
		pricePerStick: 32,
		quantity: stock.baieido?.['bikou-kobunboku'] || 0,
		isActive: true,
		inStock: true,
	},
...
const premium: Incense[] = [
	{
		...
		price: 0,
		pricePerStick: 48,
		quantity: stock.baieido?.['shu-koh-koku'] || 0,
		isActive: true,
		inStock: true,
	},
];
