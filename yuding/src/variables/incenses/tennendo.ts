...
const premium: Incense[] = [
...

	{
		...
		originalTitle: '鴻臚館',
		slug: 'khorokan',
		description: 'Сандал Корокана производится из чистейшего старого горного сандала из Майсура, Индия (с добавлением лишь табуноки в качестве связующего вещества). Это невероятно насыщенный и мягкий аромат с тонкой сладостью и характерными пряными нотками располагает к отдыху и расслаблению. Настоятельно рекомендуется ценителям сандалового дерева. *табуноки (также называемая макко) — это кора дерева Machilus thunbergii, которая служит натуральным водорастворимым клеем и основой для благовоний.',
