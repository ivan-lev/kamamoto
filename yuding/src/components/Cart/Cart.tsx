					...
					? (
						<>
							<div>
								...
								<br />
								<ul>
									<li>довести список до идеального варианта</li>
									<li>нажать кнопку "Копировать корзину"</li>
									<li>нажать одну из кнопок "Написать мне" - вас перекинет в наш диалог в Тг или Вк </li>
									<li>тапнуть на поле "Сообщение" и нажать "Вставить"</li>
								</ul>
							</div>
