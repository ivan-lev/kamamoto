** В разработке **
---
title: Общие принципы именования данных
description: Страница с описанием стандартных полей, унифицирующих именование похожих структур в типах, объектах, бд и т.д. и упрощающих дальнейшую разработку проекта
---
