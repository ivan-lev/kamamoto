...
export const sixOldKilns: Marker[] = [
	{ geocode: [34.877685, 136.058957], tooltip: 'Сигараки', kanji: '信楽焼', romaji: 'shigaraki', popup: 'Определена как Традиционное народное ремесло в 1975', image: `${baseUrl}shigaraki.webp` },
	{ geocode: [34.738748, 134.160282], tooltip: 'Бидзэн', kanji: '備前焼', romaji: 'bizen', popup: 'Определена как Традиционное народное ремесло в 1982', image: `${baseUrl}bizen.webp` },
	{ geocode: [35.970000, 136.068056], tooltip: 'Этидзэн', kanji: '越前焼', romaji: 'echizen', popup: 'Определена как Традиционное народное ремесло в 1986', image: `${baseUrl}echizen.webp` },
	{ geocode: [34.883987, 136.856262], tooltip: 'Токонамэ', kanji: '常滑焼', romaji: 'tokoname', popup: 'Определена как Традиционное народное ремесло в 1976', image: `${baseUrl}tokoname.webp` },
	{ geocode: [34.692263, 135.195586], tooltip: 'Тамба (Танба)', kanji: '丹波立杭焼', romaji: 'tamba tanba tachikui', popup: 'Определена как Традиционное народное ремесло в 1978', image: `${baseUrl}tamba.webp` },
	{ geocode: [35.224660, 137.107372], tooltip: 'Сэто', kanji: '瀬戸焼', romaji: 'seto', popup: '', image: `${baseUrl}seto.webp` },
];

export const sevenKilnsOfEnshu: Marker[] = [
	{ geocode: [33.702067, 130.783679], tooltip: 'Агано', kanji: '上野焼', romaji: 'agano', popup: 'Определена как Традиционное <br> народное ремесло в 1983 году', image: `${baseUrl}agano.webp` },
	{ geocode: [34.669432, 135.798605], tooltip: 'Акахада', kanji: '赤膚焼', romaji: 'akahada', popup: '', image: `${baseUrl}akahada.webp` },
	{ geocode: [34.988499, 135.894090], tooltip: 'Дзэдзэ', kanji: '膳所焼', romaji: 'zeze', popup: '', image: `${baseUrl}zeze.webp` },
	{ geocode: [34.910988, 135.812608], tooltip: 'Асахи', kanji: '朝日焼', romaji: 'asahi', popup: '', image: `${baseUrl}asahi.webp` },
	{ geocode: [34.861668, 135.624129], tooltip: 'Кособэ', kanji: '古曾部', romaji: 'kosobe', popup: '', image: `${baseUrl}kosobe.webp` },
	{ geocode: [34.837026, 138.163954], tooltip: 'Ситоро', kanji: '志戸呂焼', romaji: 'shitoro', popup: '', image: `${baseUrl}shitoro.webp` },
	{ geocode: [33.579506, 130.351696], tooltip: 'Такатори', kanji: '高取焼', romaji: 'takatori', popup: '', image: `${baseUrl}takatori.webp` },
];

export const traditionalKilns: Marker[] = [
	{ geocode: [37.452575, 139.889752], tooltip: 'Айдзу Хонго', kanji: '会津本郷焼', romaji: 'aizu hongo', popup: 'Определена как Традиционное <br> народное ремесло в 1993 году', image: `${baseUrl}aizu-hongo.webp` },
	{ geocode: [35.225345, 137.128556], tooltip: 'Акадзу', kanji: '赤津焼', romaji: 'akazu', popup: 'Определена как Традиционное <br> народное ремесло в 1977 году', image: `${baseUrl}akazu.webp` },
	{ geocode: [32.386185, 130.177620], tooltip: 'Амакуса', kanji: '天草陶磁器', romaji: 'amakusa tojiki yaki', popup: 'Определена как Традиционное <br> народное ремесло в 2003 году', image: `${baseUrl}amakusa.webp` },
	...
	{ geocode: [35.012839, 135.780895], tooltip: 'Кё / Киёмидзу', kanji: '京焼 清水焼', romaji: 'kyo kiyomizu', popup: 'Определены как Традиционные <br> народные ремёсла в 1977 году <br> <a target="_blank" href="/ceramic-styles/kyo">Читать статью</a>', image: `${baseUrl}kyo.webp` },
	{ geocode: [33.432530, 130.847227], tooltip: 'Коисивара', kanji: '小石原焼', romaji: 'koishiwara', popup: 'Определена как Традиционное <br> народное ремесло в 1975 году', image: `${baseUrl}koishiwara.webp` },
	{ geocode: [36.302762, 136.310187], tooltip: 'Кутани', kanji: '九谷焼', romaji: 'kutani', popup: 'Определена как Традиционное <br> народное ремесло в 1975 году', image: `${baseUrl}kutani.webp` },
	{ geocode: [36.465884, 140.105830], tooltip: 'Масико', kanji: '益子焼', romaji: 'mashiko', popup: 'Определена как Традиционное <br> народное ремесло в 1979 году', image: `${baseUrl}mashiko.webp` },
	{ geocode: [33.177025, 129.724736], tooltip: 'Микавати', kanji: '三川内焼', romaji: 'mikawachi', popup: 'Определена как Традиционное <br> народное ремесло в 1978 году <br> <a target="_blank" href="/ceramic-styles/mikawachi">Читать статью</a>', image: `${baseUrl}mikawachi.webp` },
	{ geocode: [35.381446, 137.153613], tooltip: 'Мино', kanji: '美濃焼', romaji: 'mino', popup: 'Определена как Традиционное <br> народное ремесло в 1978 году', image: `${baseUrl}mino.webp` },
	{ geocode: [37.494573, 141.000652], tooltip: 'Обори Cома', kanji: '大堀相馬焼', romaji: 'obori soma', popup: 'Определена как Традиционное <br> народное ремесло в 1978 году', image: `${baseUrl}obori-soma.webp` },
	{ geocode: [34.168590, 134.540929], tooltip: 'Отани', kanji: '大谷焼', romaji: 'otani', popup: 'Определена как Традиционное <br> народное ремесло в 2003 году', image: `${baseUrl}otani.webp` },
	{ geocode: [38.018274, 138.368385], tooltip: 'Садо Мумёи', kanji: '無名異焼', romaji: 'sado mumyoi', popup: 'Определена как Традиционное <br> народное ремесло в 2024 году', image: `${baseUrl}sado-mumyoi.webp` },
	{ geocode: [31.598611, 130.554720], tooltip: 'Сацума', kanji: '薩摩焼', romaji: 'satsuma', popup: 'Определена как Традиционное <br> народное ремесло в 2002 году', image: `${baseUrl}satsuma.webp` },
	{ geocode: [32.976934, 130.475048], tooltip: 'Сёдай', kanji: '小代焼', romaji: 'shodai', popup: 'Определена как Традиционное <br> народное ремесло в 2003 году', image: `${baseUrl}shodai.webp` },
	{ geocode: [35.180295, 136.906712], tooltip: 'Сансю Онигавара', kanji: '三州鬼瓦', romaji: 'sanshu onigawara', popup: 'Определена как Традиционное <br> народное ремесло в 2017 году', image: `${baseUrl}sanshu-onigawara.webp` },
	{ geocode: [35.215660, 137.095372], tooltip: 'Сэто Сомэцукэ', kanji: '瀬戸焼 染付', romaji: 'seto sometsuke', popup: 'Определена как Традиционное <br> народное ремесло в 1997 году', image: `${baseUrl}seto-sometsuke.webp` },
	{ geocode: [33.759081, 132.789792], tooltip: 'Тобэ', kanji: '砥部焼', romaji: 'tobe', popup: 'Определена как Традиционное <br> народное ремесло в 1976 году', image: `${baseUrl}tobe.webp` },
	{ geocode: [33.141832, 129.912049], tooltip: 'Хасами', kanji: '波佐見焼', romaji: 'hasami', popup: 'Определена как Традиционное <br> народное ремесло в 1978 году', image: `${baseUrl}hasami.webp` },
	{ geocode: [34.422368, 131.409853], tooltip: 'Хаги', kanji: '萩焼', romaji: 'hagi', popup: 'Определена как Традиционное <br> народное ремесло в 2002 году <br> <a target="_blank" href="/ceramic-styles/hagi">Читать статью</a>', image: `${baseUrl}hagi.webp` },
	{ geocode: [26.216389, 127.689349], tooltip: 'Цубоя', kanji: '壺屋焼', romaji: 'tsuboya', popup: 'Определена как Традиционное <br> народное ремесло в 1976 году', image: `${baseUrl}tsuboya.webp` },
];
