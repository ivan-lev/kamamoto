...
export default function Exhibitions() {
	...
	return (
		<>
			<Seo title="Камамото: мероприятия, на которых представлена коллекция" description="Страница со списком выставок, симпозиумов, фестивалей и мероприятий, на которых были представлены предметы из коллекции" />
