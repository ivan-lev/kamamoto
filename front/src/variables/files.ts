...
export const files: Resources = [
	...
	},
	{
		...
		description: 'Логотип в формате SVG, весом 12 КБ. Масштабируемый векторный вариант для размещения на макетах для печати',
	},
	{
		id: 2,
	...
	},
	{
		...
		description: 'Qr-код в формате SVG, весом 167 КБ. Масштабируемый векторный вариант для размещения на макетах для печати',
	},
];
