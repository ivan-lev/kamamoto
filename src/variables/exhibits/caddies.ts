...
export const caddies: Exhibits = [
  ...
  },
  {
    ...
    potterInfo: `<p>Мастер родился 27 декабря 1934 года. В 1950 году окончил начальную школу Коисивара и занялся семейным бизнесом, а в 1953 получил имя Такотори в 13-м поколении.</p><p>Вехи в карьере мастера:</p>
    <ul>
