...
■特別展（現代北陸陶芸の美）招待出品
  ...
  {
    id: 2759,
    name: 'Юноми с хвощём мастера Миёси Ацусихо и художника Кониси Ёсидзуми',
    potterName: 'Миёси Ацусихо, Кониси Ёсидзуми',
    potterJapaneseName: '三好厚峰, 小西嘉純',
    potterPhoto: 'konishi-yoshizumi.jpg',
    additionalPhotos: false,
    category: 'cups',
    age: '~1992',
    style: 'unknown',
    description: `<p>Чаша, выполненная около 1992 годав префектуре Кагава мастером Миёси Ацусихо (三好 厚峰) в печи Хикири-гама (燧窯) и украшенная художником Кониси Ёсидзуми (小西 嘉純) изображением хвоща. Рисунок выполнен подглазурными красками с оксидом железа и кобальтом. На дне пиалы стоит марка гончара.</p>
    <p>Надписи боковине коробки 湯呑 - пиала (справа), 燧窯 - название печи (слева мелким шрифтом), 厚峰作 - выполнено Ацусихо (слева рядом с красной печатью 厚). На внутренней стороне крышки: 土筆 - хващ, и 小西嘉純 - красная печать с именем художника.</p>`,
    potterInfo: `<span>Пиала интересна тем, что ниформацию о гончаре найти не удалось, но художник, расписавший пиалу оставил заметный след в развитии культуры Кагавы. К пиале приложен бумажный документ с информацией о его карьере:<span/>
    <ul>
    <li>родился в мае 1920 годав в Эноки, Котохира-тё, Накатадо-гун, префектура Кагава</li></li>
    <li>1948 выиграл премию на выставке Ассоциации творческих искусств (創造美術協会展), получил награду художника на всекансайской выставке Художественной ассоциации Кодо (行動美術協会), отобран для участия в третьей выставке Художественной ассоциации Кодо</li>
    <li>1949 рекомендован к членству в Ассоциации творческих искусств (創造美術協会)</li>
    <li>1955 рекомендован к членству в Художественной ассоциации Кодо (行動美術協会)</li>
    <li>1958 приглашен принять участие в выставке 100 новых современных художников-фигуративистов (現代具象作家新人100人展)</li>
    <li>1969 создал фрески в зале Ивасимидзу города Такамацу и в железнодорожном зале Коти</li>
    <li>1970 создал фреску в мемориальной башне бирманского общества Кагавы (香川ビルマ会)</li>
    <li>1972 создал фреску восточного здания станции Токусима (徳島駅東ビル)</li>
    <li>1979 создал фреску в мемориальной башне бирманского общества Эхимэ (愛媛ビルマ会)</li>
    <li>1982 работы мастера приняты в коллекцию главного храма Дзэнцудзи (総本山善通寺宝物殿)</li>
    <li>1985 провёл выставку «Пятьдесят лет живописи» в галерее Дзэнцудзи</li>
    <li>1986 награжден за заслуги в области образования и культуры префектуры Кагава (香川県教育文化功労者)</li>
    <li>1990 провёл выставку в Культурном центре префектуры Кагава (川県文化会館)</li>
    <li>1991 создал мурал "Мияби но сато" (雅の郷) в парке Котохики города Канондзи, занимался росписью потолка зрамового зала Хирота Хатиман (広田八幡神) в городе Такамацу</li>
    </ul>`,
    price: 0,
    weigth: undefined,
    height: undefined,
