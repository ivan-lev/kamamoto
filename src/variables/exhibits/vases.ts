...
export const vases: Exhibits = [
  ...
  },
  {
    ...
    <p>Термином мэбён (매병) называют корейские сосуды с коротким горлышком (со слегка выгнутым краем), скруглёнными плечами и узкой талией. Слово происходит от китайского мейпин (梅瓶, буквально «сливовая ваза»). В отличие от китайского мейпина, корейские вазы мэбён обычно расширяются от основания. Изначально они использовались для хранения вина, а позже — как вазы для веток цветущей сливы. В 13м веке сосуды мэбён становятся больше, а их изгибы усиливаются, а примерно к началу Династии Чосон (1392–1910) они практически перестают производиться.</p>`,

    additionalDescription: `На дополнительных фотографиях, приложенных ниже, ваза династии Корё, созданная в 12м веке, рекомендованная в 2015 году Комитетом Культурного Наследия к рассмотрению и определённая начальником Управления культурного наследия Кореи как "Сокровище 1869". Даже при беглом сравнении становится очевидно, что мастер, создавший вазу из коллекции камамото, использовал в качестве референса классическую форму и приёмы декора, которые столетиями оттачивались корейскими мастерами.`,
    additionalPhotos: true,
    additionalPhotosCount: 3,
    price: 0,
    weigth: undefined,
    height: undefined,
    length: undefined,
