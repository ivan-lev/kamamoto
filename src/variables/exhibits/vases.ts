...
`,
  ...
  },
  {
    ...
    potterInfo: `<p>Като Кэия (加藤敬也) - выдающийся гончар Сэто, родившийся в 1935 году. Его заслуги в развитие керамики Сэто просто огромны, и он получил множество призов на десятках выставок.</p>
  ...
  {
    id: 2839,
    name: 'Ваза Сомэцукэ с пейзажами и геометрическим узором',
    age: undefined,
    style: 'sometsuke',
    category: ExhibitCategory.vases,
    potterName: '',
