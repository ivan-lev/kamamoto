...
Интервью с мастером Ясудзуми, проведённое в августе 2015 года Юмико Уэно:<br/>
<br/>
― Что вас сподвигло создать уникальную технику цветной инкрустации?<br/>
― После обучения у Мандзи Иноуэ, живого национального сокровища, я в основном раскрывал форму белого фарфора при помощи гончарного круга. На выставке керамического искусства около 35 лет назад учитель-критик спросил меня: «Арита умеет делать только белый фарфор?». И это было озарением. На самом деле, в Арите живёт большое количество гончаров, и я думал, что не буду создавать ничего непохожего, чтобы на меня не смотрели косо, поэтому я занимался лишь формовкой фарфора. Первой попыткой был госу (呉須) синими линиями на белом фарфоре. Простые линии постепенно усложнялись и превращались в более сложные с классическими узорами панциря черепахи и четырехсторонними узорами ёмотасуки (四方襷).<br/>
<br/>
― В чём состоит суть вашей техники?<br/>
― Чтобы создать на фарфоровой поверхности изящный линейный узор, который нельзя создать при помощи кисти, нужно сделать вручную резной узор, пока поверхность еще мягкая, нанести воском ограничители и применить пигмент. Воск выжигается для каждого цвета, процесс повторяется до момента готовности. Если повторять это многократно, то к моменту готовности могут образоваться трещины, поэтому в последнее время я придумываю как сократить количество обжигов.<br/>
<br/>
― По завершении появляется сложный узор.
― Даже если цвет один, он будет выглядеть по-разному там, где есть вырез, и там, где его нет. Пересекающиеся линии механические, но основа и уток кажутся переплетенными, и они образуют сложный узор. Переплетение линий создает тонкий визуальный эффект, и так можно создавать множество оттенков, которые превышают количество фактически используемых цветов. Вы когда-нибудь видели мозаику в церкви в Стамбуле, Турция? Это полезный визуальный эффект.
<br/>
― Что такое пунктирная инкрустация?<br/>
― Это метод нанесения пигмента на поверхность с помощью хлопковой иглы, пока поверхность фарфора мягкая. Пожалуйста, посмотрите внимательно. Вы можете увидеть бесчисленные отверстия от игл. Результат похож на пуантилизм в живописи. Этот тонкий процесс окраски — задача для упорных.<br/>
<br/>
― Почему вы не научите этой технике своего сына Дзюна?<br/>
― Таким хлопотным делом никто не занимается, и не будет заниматься в будущем.`,
    price: 0,
    weigth: undefined,
    height: undefined,
    length: undefined,
