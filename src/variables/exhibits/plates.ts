...
export const plates: Exhibits = [
  ...
  },
  {
    ...
    <p>Керамика Киёмидзу (清水焼) - это тип керамики Кё, традиционно из района Годзёдзака, расположенного недалеко от храма Киёмидзу в Киото. История изделий Киёмидзу восходит к периоду Момояма. Эти гончарные изделия по-прежнему изготавливаются и расписываются вручную.</p>
    <p>Тарелка выполнена в технике кинсаи ироэ, что примерно переводится как «золотая краска на цветном изображении». Изделия Ироэ (буквально «цветное изображение» по-японски) первоначально производились в городах Канадзава, Комацу, Кага и Номи в южной части префектуры Исикава. Техника восходит к 1650-м годам и зародилась в деревне Кутани. Прозрачная глазурь на изделие, и оно обжигается для блеска, затем эмалевидная краска наносится на глазурь и изделие снова обжигается.</p>`,
    additionalDescription: ``,
    additionalPhotos: false,
    additionalPhotosCount: undefined,
    style: 'kiyomizu',
