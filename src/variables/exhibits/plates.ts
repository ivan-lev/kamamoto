...
export const plates: Exhibits = [
  ...
  },
  {
    ...
    category: ExhibitCategory.plates,
    style: 'kyo',
    description: `<p>Тарелка с изображением ученых мужей и стихотворением поэта Какиномото-но Хитомаро (662-710). Знаки каны изменены: что-то написано азбукой, а не иероглифами, но, скорее всего, на свитке эти строки:</p>
    <blockquote>ほのぼのと明石の浦の朝霧に島隠れ行く舟をしぞ思ふ<br/><br/>
    Едва (рассветает), в утреннем тумане залива Акаси, скрываясь за островом, плывет лодка - с проникновенным чувством (на нее) смотрю.<br/><br/>
    (перевод Марии Третьяковой)
    </blockquote>
    <p>Имя поэта также написано не совсем каноническим образом: не 柿本人麻呂, а 柿本人麿</p>`,
    additionalDescription: ``,
    price: 0,
    weigth: undefined,
    height: undefined,
